...
import { humanInteract } from "./helpers/humanBahavior.js"
...
export async function scrapeLinkedInJobs() {
  ...
  for (const url of urls) {
    ...
    // Human-like interaction on search results
    ...
    for (let job of jobs) {
      ...
      // Use unified human interaction on job page
      await humanInteract(page, 5, '.jobs-description__container');
